...
The app is designed with privacy in mind; it runs on your device instead of a server and all data is stored only locally, per default. Yet, data is stored in a single file and can be easily distributed.
